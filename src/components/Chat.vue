    ...
    <div class="messaging">
        <div class="inbox_msg">
            ...
            <div class="msg_history">
                ...
                <div class="received_msg" v-if="message.author == authUser.displayName">
                    <div class="received_withd_msg">
                    <p>{{ message.message }}</p>
                    <span class="time_date"> {{ message.createdAt.seconds | moment }}</span></div>
                </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        fetchMessages(){
            firebase.firestore().collection('chat').orderBy('createdAt').onSnapshot((querySanpShot) => {
                let allMessages = []
